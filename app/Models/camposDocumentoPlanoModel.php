...
class camposDocumentoPlanoModel extends Model
{
    protected $table = 'CAMPOS_DOCUMENTO_PLANO';
    protected $primaryKey = 'IN_ID_CAMPO';
    public $timestamps = false;
    public $incrementing = false;
    protected $fillable = [
        'IN_ID_DOC_PLANO','VC_VALOR_CADENA_1','VC_VALOR_CADENA_2','VC_VALOR_CADENA_3',
    ...
    public function documentoPlano () {
        return $this->belongsTo('App\Models\documentoPlanoModel','IN_ID_DOC_PLANO');
    }
}
