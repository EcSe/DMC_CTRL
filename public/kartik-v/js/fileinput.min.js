...
! function(e) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], e) : "object" == typeof module && module.exports ? module.exports = e(require("jquery")) : e(window.jQuery) }(function(e) {
    ...
    t = {
        ...
        getFileRelativePath: function(e) { return String(e.relativePath || e.webkitRelativePath || t.getFileName(e) || null) },
        ...
        getElapsed: function(t) {
            ...
            return Object.keys(n).forEach(function(e) { r[e] = Math.floor(i / n[e]), i -= r[e] * n[e] }), e.each(r, function(e, t) { t > 0 && (a += (a ? " " : "") + t + e.substring(0, 1)) }), a
        },
        ...
        _initFileManager: function() {
            ...
            i.fileManager = {
                ...
                isPending: function(t) { return -1 === e.inArray(t, i.fileManager.processed) && i.fileManager.exists(t) },
                ...
                getImageIdList: function() { return Object.keys(i.fileManager.loadedImages) },
                ...
                getThumb: function(t) { var a = null; return i._getThumbs().each(function() { e(this).attr("data-fileid") === t && (a = e(this)) }), a },
                getThumbIndex: function(e) { var t = e.attr("data-fileid"); return i.fileManager.getIndex(t) },
                getIdList: function() { return Object.keys(i.fileManager.stack) },
                ...
                setProcessed: function(e) { i.fileManager.processed.push(e) },
                ...
                i.resumableManager = {
                    ...
                    check: function() {
                        var t = i.resumableManager,
                            a = !0;
                        e.each(t.logs, function(e, t) { return t ? void 0 : (a = !1, !1) }), a && (clearInterval(t.chunkIntervalId), t.setProcessed("success"))
                    },
                    ...
                    testUpload: function() {
                        ...
                        return u.testUrl ? (c.testing = !0, a = new FormData, r = p.stack[f], i._setUploadData(a, { fileId: f, fileName: r.fileName, fileSize: r.size, fileRelativePath: r.relativePath, chunkSize: c.chunkSize, chunkCount: c.chunkCount }), n = function(e) { d = i._getOutData(a, e), i._raise("filetestbeforesend", [f, p, c, d]) }, o = function(r, n, o) {
                            ...
                            var l = i.uploadParamNames,
                                ...
                                u = [f, p, c, d];
                            r[s] && t.isArray(r[s]) ? (c.processed[f] || (c.processed[f] = {}), e.each(r[s], function(e, t) { c.logs[t] = !0, c.processed[f][t] = !0 }), c.processed[f].data = r, i._raise("filetestsuccess", u)) : i._raise("filetesterror", u), c.testing = !1
                    ...
                    pushAjax: function(e, t) { i.resumableManager.stack.push([e, t]) },
        ...
        _initTemplateDefaults: function() {
            ...
            i = '{preview}\n<div class="kv-upload-progress kv-hidden"></div><div class="clearfix"></div>\n<div class="input-group {class}">\n  {caption}\n<div class="input-group-btn input-group-append">\n      {remove}\n      {cancel}\n      {pause}\n      {upload}\n      {browse}\n    </div>\n</div>', a = '{preview}\n<div class="kv-upload-progress kv-hidden"></div>\n<div class="clearfix"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n', r = '<div class="file-preview {class}">\n    {close}    <div class="{dropClass}">\n    <div class="file-preview-thumbnails">\n    </div>\n    <div class="clearfix"></div>    <div class="file-preview-status text-center text-success"></div>\n    <div class="kv-fileinput-error"></div>\n    </div>\n</div>', o = t.closeButton("fileinput-remove"), n = '<i class="glyphicon glyphicon-file"></i>', l = '<div class="file-caption form-control {class}" tabindex="500">\n  <span class="file-caption-icon"></span>\n  <input class="file-caption-name" onkeydown="return false;" onpaste="return false;">\n</div>', s = '<button type="{type}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</button>', d = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</a>', c = '<div tabindex="500" class="{css}" {status}>{icon} {label}</div>', u = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + t.MODAL_ID + 'Label"></div>', p = '<div class="modal-dialog modal-lg{rtl}" role="document">\n  <div class="modal-content">\n    <div class="modal-header">\n      <h5 class="modal-title">{heading}</h5>\n      <span class="kv-zoom-title"></span>\n      <div class="kv-zoom-actions">{toggleheader}{fullscreen}{borderless}{close}</div>\n    </div>\n    <div class="modal-body">\n      <div class="floating-buttons"></div>\n      <div class="kv-zoom-body file-zoom-content {zoomFrameClass}"></div>\n{prev} {next}\n    </div>\n  </div>\n</div>\n', f = '<div class="progress">\n    <div class="{class}" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n        {status}\n     </div>\n</div>{stats}', Z = '<div class="text-info file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>', g = " <samp>({sizeText})</samp>", m = '<div class="file-thumbnail-footer">\n    <div class="file-footer-caption" title="{caption}">\n        <div class="file-caption-info">{caption}</div>\n        <div class="file-size-info">{size}</div>\n    </div>\n    {progress}\n{indicator}\n{actions}\n</div>', v = '<div class="file-actions">\n    <div class="file-footer-buttons">\n        {download} {upload} {delete} {zoom} {other}    </div>\n</div>\n{drag}\n<div class="clearfix"></div>', h = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n', w = '<button type="button" onclick="guardarImagen()" class="kv-file-upload {uploadClass}" title="{uploadTitle}">{uploadIcon}</button>', b = '<a class="kv-file-download {downloadClass}" title="{downloadTitle}" href="{downloadUrl}" download="{caption}" target="_blank">{downloadIcon}</a>', _ = '<button type="button" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>', C = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>', y = '<div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>', x = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-fileid="{fileid}" data-template="{template}"', T = x + '><div class="kv-file-content">\n', P = x + ' title="{caption}"><div class="kv-file-content">\n', I = "</div>{footer}\n</div>\n", E = "{content}\n", O = " {style}", k = '<div class="kv-preview-data file-preview-html" title="{caption}"' + O + ">{data}</div>\n", S = '<img src="{data}" class="file-preview-image kv-preview-data" title="{title}" alt="{alt}"' + O + ">\n", F = '<textarea class="kv-preview-data file-preview-text" title="{caption}" readonly' + O + ">{data}</textarea>\n", A = '<iframe class="kv-preview-data file-preview-office" src="https://view.officeapps.live.com/op/embed.aspx?src={data}"' + O + "></iframe>", z = '<iframe class="kv-preview-data file-preview-gdocs" src="https://docs.google.com/gview?url={data}&embedded=true"' + O + "></iframe>", D = '<video class="kv-preview-data file-preview-video" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</video>\n", M = '<!--suppress ALL --><audio class="kv-preview-data file-preview-audio" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</audio>\n", $ = '<embed class="kv-preview-data file-preview-flash" src="{data}" type="application/x-shockwave-flash"' + O + ">\n", j = '<embed class="kv-preview-data file-preview-pdf" src="{data}" type="application/pdf"' + O + ">\n", U = '<object class="kv-preview-data file-preview-object file-object {typeCss}" data="{data}" type="{type}"' + O + '>\n<param name="movie" value="{caption}" />\n' + t.OBJECT_PARAMS + " " + t.DEFAULT_PREVIEW + "\n</object>\n", R = '<div class="kv-preview-data file-preview-other-frame"' + O + ">\n" + t.DEFAULT_PREVIEW + "\n</div>\n", B = '<div class="kv-zoom-cache" style="display:none">{zoomContent}</div>', L = { width: "100%", height: "100%", "min-height": "480px" }, N._isPdfRendered() && (j = N.pdfRendererTemplate.replace("{renderer}", N._encodeURI(N.pdfRendererUrl))), N.defaults = {
                ...
                previewContentTemplates: { generic: E, html: k, image: S, text: F, office: A, gdocs: z, video: D, audio: M, flash: $, object: U, pdf: j, other: R },
                allowedPreviewTypes: ["image", "html", "text", "video", "audio", "flash", "pdf", "object"],
                previewTemplates: {},
                previewSettings: { image: { width: "auto", height: "auto", "max-width": "100%", "max-height": "100%" }, html: { width: "213px", height: "160px" }, text: { width: "213px", height: "160px" }, office: { width: "213px", height: "160px" }, gdocs: { width: "213px", height: "160px" }, video: { width: "213px", height: "160px" }, audio: { width: "100%", height: "30px" }, flash: { width: "213px", height: "160px" }, object: { width: "213px", height: "160px" }, pdf: { width: "100%", height: "160px" }, other: { width: "213px", height: "160px" } },
            ...
            i.previewCache = {
                ...
                get: function(a, r) {
                    var n, o, l, s, d, c, u, p, f = "init_" + a,
                        ...
                        _ = function(e, a, r, o, l, s, d, c, u) { return c = " file-preview-initial " + t.SORT_CSS + (c ? " " + c : ""), n = m && m.fileId || "file_" + l, i._generatePreviewTemplate(e, a, r, o, l, n, !1, null, c, s, d, u, b, m && m.zoomData || a) };
                ...
                footer: function(e, a, r) {
                    ...
                    var o, l = n.config[e],
                        ...
                        x = c === !1 && a;
                    return _ = _ && l.downloadUrl !== !1 && !!v, o = i._renderFileActions(l, !1, _, b, C, y, x, c, u, !0, v, h), i._getLayoutTemplate("footer").setTokens({ progress: i._renderThumbProgress(), actions: o, caption: s, size: i._getSize(r), width: d, indicator: "" })
                }
            }, i.previewCache.init()
        },
        ...
        _scanDroppedItems: function(e, i, a) {
            ...
            e.isFile ? e.file(function(e) { i.push(e) }, s) : e.isDirectory && (n = e.createReader(), (o = function() {
        ...
        _uploadSingle: function(i, a, r) {
            ...
            w.enableResumableUpload || (w.showPreview && (o = w.fileManager.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(I) || (h = function() { c ? b.errors.push(a) : b.removeFile(a), b.setProcessed(a), b.isProcessed() && (w.fileBatchCompleted = !0) }, l = function() {
                ...
                n = w._getOutData(C, p, l), e.extend(!0, I, n), setTimeout(function() { t.isEmpty(l) || t.isEmpty(l.error) ? (w.showPreview && (w._setThumbStatus(o, "Success"), s.hide(), w._initUploadSuccess(l, o, r), w._setProgress(101, u)), w._raise("fileuploaded", [n, g, i]), r ? h() : w.fileManager.remove(o)) : (c = !0, f = w._parseError(T, p, w.msgUploadError, w.fileManager.getFileName(a)), w._showFileError(f, I), w._setPreviewError(o, !0), w.retryErrorUploads || s.hide(), r && h(), w._setProgress(101, e("#" + g).find(".file-thumb-progress"), w.msgUploadError)) }, w.processDelay)
            }, m = function() { setTimeout(function() { w.showPreview && (s.removeAttr("disabled"), d.removeAttr("disabled"), o.removeClass("file-uploading")), r ? l() : (w.unlock(!1), w._clearFileInput()), w._initSuccessThumbs() }, w.processDelay) }, v = function(t, i, n) { f = w._parseError(T, t, n, w.fileManager.getFileName(a)), c = !0, setTimeout(function() { r && h(), w.fileManager.setProgress(a, 100), w._setPreviewError(o, !0), w.retryErrorUploads || s.hide(), e.extend(!0, I, w._getOutData(C, t)), w._setProgress(101, u, w.msgAjaxProgressError.replace("{operation}", T)), w._setProgress(101, o.find(".file-thumb-progress"), w.msgUploadError), w._showFileError(f, I) }, w.processDelay) }, C.append(w.uploadFileAttr, P.file, E), w._setUploadData(C, { fileId: a }), w._ajaxSubmit(p, g, m, v, C, a, i)))
        },
            ...
            i.showPreview && (i._initZoomButton(), i.getFrames(" .kv-file-remove").each(function() {
                ...
                i._handler(s, "click", function() {
                    return l = i._raise("filepreremove", [c, u]), l !== !1 && i._validateMinCount() ? (r = d.hasClass("file-preview-error"), t.cleanMemory(d), void d.fadeOut("slow", function() {
                        t.cleanZoomCache(a.find("#zoom-" + c)), i.fileManager.remove(d), i._clearObjects(d), d.remove(), c && r && i.$errorContainer.find('li[data-thumb-id="' + c + '"]').fadeOut("fast", function() { e(this).remove(), i._errorsExist() || i._resetErrors() }), i._clearFileInput();
        ...
        _getExifObj: function(e) {
            ...
            try { a = window.piexif ? window.piexif.load(e) : null } catch (n) { a = null, r = n && n.message || "" }
        ...
        _validateImageOrientation: function(t, i, a, r, n, o, l, s) {
            var d, c, u = this,
                p = u.autoOrientImage;
            return d = p ? u._getExifObj(s) : null, (c = d ? d["0th"][piexif.ImageIFD.Orientation] : null) ? (u.setImageOrientation(t, e("#zoom-" + a + " img"), c, e("#" + a)), u._raise("fileimageoriented", { $img: t, file: i }), void u._validateImage(a, r, n, o, l, s, d)) : void u._validateImage(a, r, n, o, l, s, d)
        },
        ...
        _getResizedImage: function(i, a, r, n) {
            var o, l, s, d, c, u, p, f, g, m, v = this,
                ...
                S = a.thumb,
                F = a.exifObj;
            if (c = function(e, t, i) { v.isAjaxUpload ? v._showFileError(e, t, i) : v._showError(e, t, i), v._setPreviewError(S) }, f = v.fileManager.getFile(i), g = { id: E, index: k, fileId: i }, m = [i, E, k], (!f || !x || C >= w && y >= b) && (x && f && v._raise("fileimageresized", m), r.val++, r.val === n && v._raise("fileimagesresized"), !x)) return void c(v.msgImageResizeError, g, "fileimageresizeerror");
            ...
            try { P.drawImage(h, 0, 0, w, b), d = T.toDataURL(I, v.resizeQuality), F && (p = window.piexif.dump(F), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), v.fileManager.setFile(i, o), v._raise("fileimageresized", m), r.val++, r.val === n && v._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(v.msgImageResizeError, g, "fileimageresizeerror") } catch (A) { r.val++, r.val === n && v._raise("fileimagesresized", [void 0, void 0]), u = v.msgImageResizeException.replace("{errors}", A.message), c(u, g, "fileimageresizeexception") }
        },
        ...
        _resetFileStack: function() {
            ...
            i._getThumbs().each(function() {
                var r = e(this),
                    ...
                    o = r.attr("id");
                "-1" !== n && -1 !== n && (i.fileManager.getFile(r.attr("data-fileid")) ? r.attr({ id: "uploaded-" + t.uniqId(), "data-fileindex": "-1" }) : (r.attr({
                    id: i.previewInitId + "-" + a,
                    "data-fileindex": a
                }), a++), i.$preview.find("#zoom-" + o).attr({ id: "zoom-" + r.attr("id"), "data-fileindex": r.attr("data-fileindex") }))
            })
        },
        ...
        readFiles: function(i) {
            ...
            var a, r = this,
                ...
                b = function(t, n, o, l, s) {
                    var d = e.extend(!0, {}, r._getOutData(null, {}, {}, i), { id: o, index: l, fileId: s }),
                        c = e("#" + o),
            ...
            r.fileManager.clearImages(), e.each(i, function(e, t) {
                ...
                var C, y, x, T, P, I, E, k, S, F, A, z, D, M, $ = g + _,
                    U = u + "-" + $,
                    j = i[_],
                    R = f.text,
                    O = f.image,
                    ...
                    Z = (j && j.size || 0) / 1e3,
                    N = "",
                    H = t.createObjectURL(j),
                    q = 0,
                    W = "",
                    V = 0,
                    K = function() {
                        var e = c.setTokens({ index: _ + 1, files: p, percent: 50, name: L });
                        setTimeout(function() { s.html(e), r._updateFileDetails(p), a(_ + 1) }, r.processDelay), r._raise("fileloaded", [j, U, _, o])
                    };
                if (j) {
                    if (S = r.fileManager.getId(j), v > 0)
                        for (y = 0; v > y; y++) E = m[y], k = r.msgFileTypes[E] || E, W += 0 === y ? k : ", " + k;
                    ...
                    if (t.isEmpty(h) || (N = new RegExp("\\.(" + h.join("|") + ")$", "i")), C = Z.toFixed(2), r.maxFileSize > 0 && Z > r.maxFileSize) return x = r.msgSizeTooLarge.setTokens({ name: L, size: C, maxSize: r.maxFileSize }), void b(x, j, U, _, S);
                    if (null !== r.minFileSize && Z <= t.getNum(r.minFileSize)) return x = r.msgSizeTooSmall.setTokens({ name: L, size: C, minSize: r.minFileSize }), void b(x, j, U, _, S);
                    if (!t.isEmpty(m) && t.isArray(m)) { for (y = 0; y < m.length; y += 1) P = m[y], F = f[P], q += F && "function" == typeof F && F(j.type, t.getFileName(j)) ? 1 : 0; if (0 === q) return x = r.msgInvalidFileType.setTokens({ name: L, types: W }), void b(x, j, U, _, S) }
                    if (0 === q && !t.isEmpty(h) && t.isArray(h) && !t.isEmpty(N) && (I = t.compare(L, N), q += t.isEmpty(I) ? 0 : I.length, 0 === q)) return x = r.msgInvalidFileExtension.setTokens({ name: L, extensions: w }), void b(x, j, U, _, S);
                    if (r.isAjaxUpload && r.fileManager.exists(S)) return x = r.msgDuplicateFile.setTokens({ name: L, size: C }), b(x, j, U, _, S), T = e("#" + U), void(T && T.length && T.remove());
                    if (!r.canPreview(j)) return r.isAjaxUpload && r.fileManager.add(j), r.showPreview && (l.addClass("file-thumb-loading"), r._previewDefault(j, U), r._initFileActions()), void setTimeout(function() { r._updateFileDetails(p), a(_ + 1), r._raise("fileloaded", [j, U, _]) }, 10);
                    A = R(j.type, L), z = B(j.type, L), D = O(j.type, L), s.html(d.replace("{index}", _ + 1).replace("{files}", p)), l.addClass("file-thumb-loading"), o.onerror = function(e) { r._errorHandler(e, L) }, o.onload = function(i) {
                        var a, n, l, s, d, c, u = [],
                            p = function(e) {
                                var t = new FileReader;
                                t.onerror = function(e) { r._errorHandler(e, L) }, t.onload = function(e) { r._previewFile(_, j, e, U, H, n), r._initFileActions(), K() }, e ? t.readAsText(j, r.textEncoding) : t.readAsDataURL(j)
                            };
                        if (n = { name: L, type: j.type }, e.each(f, function(e, t) { "object" !== e && "other" !== e && "function" == typeof t && t(j.type, L) && V++ }), 0 === V) { for (l = new Uint8Array(i.target.result), y = 0; y < l.length; y++) s = l[y].toString(16), u.push(s); if (a = u.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(o.result), c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, j.type)), n = { name: L, type: c }, A = R(c, ""), z = B(c, ""), D = O(c, ""), M = A || z, M || D) return void p(M) }
                        r._previewFile(_, j, i, U, H, n), r._initFileActions(), K()
                    }, o.onprogress = function(e) {
                        if (e.lengthComputable) {
                            var t = e.loaded / e.total * 100,
                                i = Math.ceil(t);
                            x = c.setTokens({ index: _ + 1, files: p, percent: i, name: L }), setTimeout(function() { s.html(x) }, r.processDelay)
                        }
        ...
        resume: function() {
            ...
            return e.enableResumableUpload ? (e.paused ? i.html(e.progressPauseTemplate.setTokens({ percent: 101, status: e.msgUploadResume, stats: "" })) : t = !0, e.paused = !1, t && i.html(e.progressInfoTemplate.setTokens({ percent: 101, status: e.msgUploadBegin, stats: "" })), setTimeout(function() { a.upload() }, e.processDelay), e.$element) : e.$element
        },
        pause: function() {
            var t, i = this,
        ...
        upload: function() {
            ...
            if (n.isAjaxUpload && !n.isDisabled && n._isFileSelectionValid(l)) {
                ...
                if (n.uploadAsync || n.enableResumableUpload) {
                    for (a = n._getOutData(null), n._raise("filebatchpreupload", [a]), n.fileBatchCompleted = !1, n.uploadCache = { content: [], config: [], tags: [], append: !0 }, i = 0; r > i; i++) n.uploadCache.content[i] = null, n.uploadCache.config[i] = null, n.uploadCache.tags[i] = null;
                    n.$preview.find(".file-preview-initial").removeClass(t.SORT_CSS), n._initSortable(), n.cacheInitialPreview = n.getPreview()
                }
                return n._setProgress(2), n.hasInitData = !1, n.uploadAsync ? (i = 0, void e.each(o.stack, function(e) { n._uploadSingle(i, e, !0), i++ })) : (n._uploadBatch(), n.$element)
            }
        },
        destroy: function() {
            var t = this,
        ...
        deleteExtraData: {},
        overwriteInitial: !0,
        sanitizeZoomCache: function(t) { var i = e(document.createElement("div")).append(t); return i.find("input,select,.file-thumbnail-footer").remove(), i.html() },
    ...
    }, e.fn.fileinputLocales.en = { fileSingle: "file", filePlural: "files", browseLabel: "Buscar &hellip;", removeLabel: "Borrar", removeTitle: "Eliminar archivo", cancelLabel: "Cancelar", cancelTitle: "Abort ongoing upload", pauseLabel: "Pause", pauseTitle: "Pause ongoing upload", uploadLabel: "Cargar", uploadTitle: "Cargar archivos seleccionados", msgNo: "No", msgNoFilesSelected: "No files selected", msgCancelled: "Cancelled", msgPaused: "Paused", msgPlaceholder: "Select {files}...", msgZoomModalHeading: "Detailed Preview", msgFileRequired: "You must select a file to upload.", msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.', msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) exceeds maximum allowed upload size of <b>{maxSize} KB</b>.', msgFilesTooLess: "You must select at least <b>{n}</b> {files} to upload.", msgFilesTooMany: "Number of files selected for upload <b>({n})</b> exceeds maximum allowed limit of <b>{m}</b>.", msgFileNotFound: 'File "{name}" not found!', msgFileSecured: 'Security restrictions prevent reading the file "{name}".', msgFileNotReadable: 'File "{name}" is not readable.', msgFilePreviewAborted: 'File preview aborted for "{name}".', msgFilePreviewError: 'An error occurred while reading the file "{name}".', msgInvalidFileName: 'Invalid or unsupported characters in file name "{name}".', msgInvalidFileType: 'Invalid type for file "{name}". Only "{types}" files are supported.', msgInvalidFileExtension: 'Invalid extension for file "{name}". Only "{extensions}" files are supported.', msgFileTypes: { image: "image", html: "HTML", text: "text", video: "video", audio: "audio", flash: "flash", pdf: "PDF", object: "object" }, msgUploadAborted: "The file upload was aborted", msgUploadThreshold: "Processing...", msgUploadBegin: "Initializing...", msgUploadEnd: "Done", msgUploadResume: "Resuming upload...", msgUploadEmpty: "No valid data available for upload.", msgUploadError: "Upload Error", msgDeleteError: "Delete Error", msgProgressError: "Error", msgValidationError: "Validation Error", msgLoading: "Loading file {index} of {files} &hellip;", msgProgress: "Loading file {index} of {files} - {name} - {percent}% completed.", msgSelected: "{n} {files} selected", msgFoldersNotAllowed: "Drag & drop files only! {n} folder(s) dropped were skipped.", msgImageWidthSmall: 'Width of image file "{name}" must be at least {size} px.', msgImageHeightSmall: 'Height of image file "{name}" must be at least {size} px.', msgImageWidthLarge: 'Width of image file "{name}" cannot exceed {size} px.', msgImageHeightLarge: 'Height of image file "{name}" cannot exceed {size} px.', msgImageResizeError: "Could not get the image dimensions to resize.", msgImageResizeException: "Error while resizing the image.<pre>{errors}</pre>", msgAjaxError: "Something went wrong with the {operation} operation. Please try again later!", msgAjaxProgressError: "{operation} failed", msgDuplicateFile: 'File "{name}" of same size "{size} KB" has already been selected earlier. Skipping duplicate selection.', msgResumableUploadRetriesExceeded: "Upload aborted beyond <b>{max}</b> retries for file <b>{file}</b>! Error Details: <pre>{error}</pre>", msgPendingTime: "{time} remaining", msgCalculatingTime: "calculating time remaining", ajaxOperations: { deleteThumb: "file delete", uploadThumb: "file upload", uploadBatch: "batch file upload", uploadExtra: "form data upload" }, dropZoneTitle: "Drag & drop files here &hellip;", dropZoneClickTitle: "<br>(or click to select {files})", previewZoomButtonTitles: { prev: "View previous file", next: "View next file", toggleheader: "Toggle header", fullscreen: "Toggle full screen", borderless: "Toggle borderless mode", close: "Close detailed preview" } }, e.fn.fileinput.Constructor = i, e(document).ready(function() {
